...
| 3 | Sécurité prouvable (cœur de valeur) | 🟡 **PARTIAL** (était NO-GO) | **M1 ✅ M3 ✅ M7 ✅ HARD-03 ✅** fermés et testés **+ prouvés LIVE** (E2E Docker). **SEC-01 ACL Fabric ✅ ET SharePoint ✅ prouvés LIVE** (grant/deny contre Fabric + SharePoint `Dossiers_Clients_POC` GEREP réels, via le code gateway) + résolution groupes Graph live. Reste : test de **révocation** (write item jetable), API-compat 4.1.1. |
