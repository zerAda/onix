...
| 3 | Sécurité prouvable (cœur de valeur) | 🟡 **PARTIAL** (était NO-GO) | **M1 ✅ M3 ✅ M7 ✅ HARD-03 ✅** fermés et testés **+ prouvés LIVE** (E2E Docker). **SEC-01 ACL Fabric ✅ prouvé LIVE** (grant/deny contre Fabric+Entra GEREP réels) + résolution groupes Graph live. Reste : SharePoint par-doc (token app `Sites.Read.All`), test de **révocation** (write workspace jetable), API-compat 4.1.1. |
