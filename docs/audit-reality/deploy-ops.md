...
| Backup/rollback : `make backup`, `make restore DIR=…`, dump à chaud `pg_dump` | ✅ | `Makefile:92-96` ; `scripts/backup.sh`, `scripts/restore.sh` | Voir réserve P1 ci-dessous (projet/env). |
